...
var LengthUnit = function LengthUnit(options) {
  this.unit = "meter";
  this.amount = 0;
...
LengthUnit.systems = {
  "metric": ["micrometer", "millimeter", "centimeter", "decimeter", "meter", "decameter", "hectometer", "kilometer", "megameter", "gigameter"],
  "imperial": ["inch", "foot", "yard", "mile", "nautical-mile"],
  "uscustomary": ["inch", "foot", "yard", "mile", "nautical-mile"],
  "conversions": {
    "metric": {
      "uscustomary": {
        "micrometer": "inch",
