...
var FuelConsumptionUnit = function FuelConsumptionUnit(options) {
...
FuelConsumptionUnit.systems = {
  "metric": ["liter-per-kilometer", "liter-per-100kilometers", "kilometer-per-liter"],
  "uscustomary": ["mile-per-gallon"],
  "imperial": ["mile-per-gallon-imperial"],
  "conversions": {
    "metric": {
      "uscustomary": {
