...
var isAlpha = function isAlpha(ch) {
  ...
  return ilib.data.ctype_l ? CType._inRange(num, 'Lu', ilib.data.ctype_l) || CType._inRange(num, 'Ll', ilib.data.ctype_l) || CType._inRange(num, 'Lt', ilib.data.ctype_l) || CType._inRange(num, 'Lm', ilib.data.ctype_l) || CType._inRange(num, 'Lo', ilib.data.ctype_l) : num >= 0x41 && num <= 0x5A || num >= 0x61 && num <= 0x7A;
};
/**
 * @protected
 * @param {boolean} sync
