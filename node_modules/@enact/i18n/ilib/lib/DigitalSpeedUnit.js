...
var DigitalSpeedUnit = function DigitalSpeedUnit(options) {
  this.unit = "byte";
  this.amount = 0;
...
DigitalSpeedUnit.bitSystem = ["bit-per-second", "kilobit-per-second", "megabit-per-second", "gigabit-per-second", "terabit-per-second", "petabit-per-second"];
DigitalSpeedUnit.byteSystem = ["byte-per-second", "kilobyte-per-second", "megabyte-per-second", "gigabyte-per-second", "terabyte-per-second", "petabyte-per-second"];
/**
...
DigitalSpeedUnit.prototype.scale = function (measurementsystem, units) {
  var mSystem,
      systemName = this.getMeasurementSystem();
