...
GlyphString._isJamoLV = function (n) {
  ...
  var syllableIndex = n - syllableBase; // Check if n is a precomposed Hangul
...
GlyphString.prototype.charIterator = function () {
  ...
  function _chiterator(istring) {
    ...
    this.next = function () {
      ...
      if (ilib.data.norm.ccc && (typeof ilib.data.norm.ccc[ch] === 'undefined' || ilib.data.norm.ccc[ch] === 0)) {
        ...
        while (it.hasNext() && notdone) {
          ...
          var codePoint = IString.toCodePoint(this.nextChar, 0); // Mn characters are Marks that are non-spacing. These do not take more room than an accent, so they should be 
