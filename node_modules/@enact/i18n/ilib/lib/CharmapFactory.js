...
var CharmapFactory = function CharmapFactory(options) {
  var charsetName = options && options.name || "ISO-8859-15";
  var sync = true; // console.log("CharmapFactory: called with options: " + JSON.stringify(options));
  ...
  new Charset({
    ...
    onLoad: function onLoad(charset) {
      // name will be normalized already
      var cons,
          name = charset.getName(); // console.log("CharmapFactory: normalized charset name: " + name);
      ...
      instance = cons && new cons(JSUtils.merge(options || {}, {
        charset: charset
      }));
    }
  });
