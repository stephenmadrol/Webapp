...
var VelocityUnit = function VelocityUnit(options) {
...
VelocityUnit.systems = {
  "metric": ["kilometer-per-hour", "meter-per-second", "kilometer-per-second"],
  "imperial": ["foot-per-second", "mile-per-hour", "knot", "mile-per-second"],
  "uscustomary": ["foot-per-second", "mile-per-hour", "knot", "mile-per-second"],
  "conversions": {
    "imperial": {
      "metric": {
