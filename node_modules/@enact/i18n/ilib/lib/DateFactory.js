...
var CalendarFactory = require("./CalendarFactory.js"); // Statically depend on these even though we don't use them
...
var DateFactory = function DateFactory(options) {
  var locale,
      type,
      cons,
      sync = true,
...
DateFactory._init = function (type, options) {
  ...
  cons = IDate._constructors[type]; // pass the same options through to the constructor so the subclass
