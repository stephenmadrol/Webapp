 ...
 * @constructor
 */
var ISet = function ISet(elements) {
  this.elements = {};
...
ISet.prototype.asArray = function () {
  var keys = Object.keys(this.elements); // keys is an array of strings. Convert to numbers if necessary
