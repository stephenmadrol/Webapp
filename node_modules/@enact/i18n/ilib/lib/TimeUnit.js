...
var TimeUnit = function TimeUnit(options) {
  this.unit = "second";
  this.amount = 0;
...
TimeUnit.systems = {
  "metric": ["nanosecond", "microsecond", "millisecond", "second", "minute", "hour", "day", "week", "month", "year", "decade", "century"],
  "uscustomary": ["nanosecond", "microsecond", "millisecond", "second", "minute", "hour", "day", "week", "month", "year", "decade", "century"],
  "imperial": ["nanosecond", "microsecond", "millisecond", "second", "minute", "hour", "day", "week", "month", "year", "decade", "century"],
  "conversions": {
    "metric": {},
    "uscustomary": {},
    "imperial": {}
