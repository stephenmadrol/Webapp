 ...
 * @constructor
 */
var PhoneHandler = function PhoneHandler() {
  return this;
};
...
PhoneHandler.prototype = {
   ...
   */
  processSubscriberNumber: function processSubscriberNumber(number, fields, regionSettings) {
    var last;
    ...
    if (regionSettings.plan.getFieldLength('maxLocalLength') && fields.subscriberNumber && fields.subscriberNumber.length > regionSettings.plan.getFieldLength('maxLocalLength')) {
      fields.invalid = true;
    }
  },
   ...
   */
  processFieldWithSubscriberNumber: function processFieldWithSubscriberNumber(fieldName, length, number, currentChar, fields, regionSettings, noExtractTrunk) {
    var ret, end;
   ...
   * @param {Object} regionSettings settings used to parse the rest of the number
   */
  processField: function processField(fieldName, length, number, currentChar, fields, regionSettings) {
    var ret = {},
        end;
   ...
   * @param {Object} regionSettings settings used to parse the rest of the number
   */
  trunk: function trunk(number, currentChar, fields, regionSettings) {
    var ret, trunkLength;
   ...
   * @param {Object} regionSettings settings used to parse the rest of the number
   */
  plus: function plus(number, currentChar, fields, regionSettings) {
    var ret = {};
   ...
   * @param {Object} regionSettings settings used to parse the rest of the number
   */
  idd: function idd(number, currentChar, fields, regionSettings) {
    var ret = {};
   ...
   * @param {Object} regionSettings settings used to parse the rest of the number
   */
  country: function country(number, currentChar, fields, regionSettings) {
    var ret, cc; // found the country code of an IDD number, so save it and cause the function to 
   ...
   * @param {Object} regionSettings settings used to parse the rest of the number
   */
  cic: function cic(number, currentChar, fields, regionSettings) {
   ...
   * @param {Object} regionSettings settings used to parse the rest of the number
   */
  service: function service(number, currentChar, fields, regionSettings) {
   ...
   * @param {Object} regionSettings settings used to parse the rest of the number
   */
  area: function area(number, currentChar, fields, regionSettings) {
    ...
    if (regionSettings.plan.getFieldLength('maxLocalLength') !== undefined) {
      if (fields.trunkAccess !== undefined || fields.mobilePrefix !== undefined || fields.countryCode !== undefined || localLength > regionSettings.plan.getFieldLength('maxLocalLength')) {
   ...
   * @param {Object} regionSettings settings used to parse the rest of the number
   */
  none: function none(number, currentChar, fields, regionSettings) {
    var ret; // this is a last resort function that is called when nothing is recognized.
   ...
   * @param {Object} regionSettings settings used to parse the rest of the number
   */
  vsc: function vsc(number, currentChar, fields, regionSettings) {
    var ret, length, end;
   ...
   * @param {Object} regionSettings settings used to parse the rest of the number
   */
  cell: function cell(number, currentChar, fields, regionSettings) {
   ...
   * @param {Object} regionSettings settings used to parse the rest of the number
   */
  personal: function personal(number, currentChar, fields, regionSettings) {
   ...
   * @param {Object} regionSettings settings used to parse the rest of the number
   */
  emergency: function emergency(number, currentChar, fields, regionSettings) {
   ...
   * @param {Object} regionSettings settings used to parse the rest of the number
   */
  premium: function premium(number, currentChar, fields, regionSettings) {
   ...
   * @param {Object} regionSettings settings used to parse the rest of the number
   */
  special: function special(number, currentChar, fields, regionSettings) {
   ...
   * @param {Object} regionSettings settings used to parse the rest of the number
   */
  service2: function service2(number, currentChar, fields, regionSettings) {
   ...
   * @param {Object} regionSettings settings used to parse the rest of the number
   */
  service3: function service3(number, currentChar, fields, regionSettings) {
   ...
   * @param {Object} regionSettings settings used to parse the rest of the number
   */
  service4: function service4(number, currentChar, fields, regionSettings) {
   ...
   * @param {Object} regionSettings settings used to parse the rest of the number
   */
  cic2: function cic2(number, currentChar, fields, regionSettings) {
   ...
   * @param {Object} regionSettings settings used to parse the rest of the number
   */
  cic3: function cic3(number, currentChar, fields, regionSettings) {
   ...
   * @param {Object} regionSettings settings used to parse the rest of the number
   */
  start: function start(number, currentChar, fields, regionSettings) {
   ...
   * @param {Object} regionSettings settings used to parse the rest of the number
   */
  local: function local(number, currentChar, fields, regionSettings) {
...
var CSStateHandler = function CSStateHandler() {
  return this;
};
...
CSStateHandler.prototype.special = function (number, currentChar, fields, regionSettings) {
  var ret; // found a special area code that is both a node and a leaf. In
...
var USStateHandler = function USStateHandler() {
  return this;
};
...
USStateHandler.prototype.vsc = function (number, currentChar, fields, regionSettings) {
  var ret; // found a VSC code (ie. a "star code")

  fields.vsc = number; // treat the rest of the number as if it were a completely new number
...
var PhoneHandlerFactory = function PhoneHandlerFactory(locale, plan) {
