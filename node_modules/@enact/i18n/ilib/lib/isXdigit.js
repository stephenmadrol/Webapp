...
var isXdigit = function isXdigit(ch) {
  var num;
  ...
  return ilib.data.ctype ? CType._inRange(num, 'xdigit', ilib.data.ctype) : num >= 0x30 && num <= 0x39 || num >= 0x41 && num <= 0x46 || num >= 0x61 && num <= 0x66;
};
/**
 * @protected
 * @param {boolean} sync
