...
var NumberingPlan = function NumberingPlan(options) {
  var sync = true,
      loadParams = {};
...
NumberingPlan.prototype = {
   ...
   */
  getTrunkCode: function getTrunkCode() {
   ...
   */
  getIDDCode: function getIDDCode() {
   ...
   */
  getPlanStyle: function getPlanStyle() {
   ...
   * @return {boolean}
   */
  getContextFree: function getContextFree() {
   ...
   * @return {boolean}
   */
  getFindExtensions: function getFindExtensions() {
   ...
   * @return {boolean}
   */
  getSkipTrunk: function getSkipTrunk() {
   ...
   * @return {boolean}
   */
  getTrunkRequired: function getTrunkRequired() {
   ...
   */
  getExtendedAreaCode: function getExtendedAreaCode() {
   ...
   */
  getCommonFormatChars: function getCommonFormatChars() {
   ...
   * field is not known.
   */
  getFieldLength: function getFieldLength(field) {
