...
var DigitalStorageUnit = function DigitalStorageUnit(options) {
  this.unit = "byte";
  this.amount = 0;
...
DigitalStorageUnit.bitSystem = ["bit", "kilobit", "megabit", "gigabit", "terabit", "petabit"];
DigitalStorageUnit.byteSystem = ["byte", "kilobyte", "megabyte", "gigabyte", "terabyte", "petabyte"];
/**
