...
var EnergyUnit = function EnergyUnit(options) {
  this.unit = "joule";
  this.amount = 0;
...
EnergyUnit.aliases = (_EnergyUnit$aliases = {
  ...
  "kW-hour": "kilowatt-hour",
  "kW-hours": "kilowatt-hour"
}, _defineProperty(_EnergyUnit$aliases, "kiloWh", "kilowatt-hour"), _defineProperty(_EnergyUnit$aliases, "kWh", "kilowatt-hour"), _defineProperty(_EnergyUnit$aliases, "giga joule", "gigajoule"), _defineProperty(_EnergyUnit$aliases, "Gj", "gigajoule"), _defineProperty(_EnergyUnit$aliases, "gigajoule", "gigajoule"), _defineProperty(_EnergyUnit$aliases, "gigajoules", "gigajoule"), _defineProperty(_EnergyUnit$aliases, "mega watt hour", "megawatt-hour"), _defineProperty(_EnergyUnit$aliases, "mega watt hours", "megawatt-hour"), _defineProperty(_EnergyUnit$aliases, "megawatt hour", "megawatt-hour"), _defineProperty(_EnergyUnit$aliases, "megawatt hours", "megawatt-hour"), _defineProperty(_EnergyUnit$aliases, "megawatt-hour", "megawatt-hour"), _defineProperty(_EnergyUnit$aliases, "megawatt-hours", "megawatt-hour"), _defineProperty(_EnergyUnit$aliases, "MW hour", "megawatt-hour"), _defineProperty(_EnergyUnit$aliases, "MW hours", "megawatt-hour"), _defineProperty(_EnergyUnit$aliases, "MW-hour", "megawatt-hour"), _defineProperty(_EnergyUnit$aliases, "MW-hours", "megawatt-hour"), _defineProperty(_EnergyUnit$aliases, "megaWh", "megawatt-hour"), _defineProperty(_EnergyUnit$aliases, "MWh", "megawatt-hour"), _defineProperty(_EnergyUnit$aliases, "giga watt hour", "gigawatt-hour"), _defineProperty(_EnergyUnit$aliases, "giga watt hour", "gigawatt-hour"), _defineProperty(_EnergyUnit$aliases, "giga watt hours", "gigawatt-hour"), _defineProperty(_EnergyUnit$aliases, "gigawatt hour", "gigawatt-hour"), _defineProperty(_EnergyUnit$aliases, "gigawatt hours", "gigawatt-hour"), _defineProperty(_EnergyUnit$aliases, "gigawatt-hours", "gigawatt-hour"), _defineProperty(_EnergyUnit$aliases, "gigawatthour", "gigawatt-hour"), _defineProperty(_EnergyUnit$aliases, "GW hour", "gigawatt-hour"), _defineProperty(_EnergyUnit$aliases, "GW hours", "gigawatt-hour"), _defineProperty(_EnergyUnit$aliases, "GW-hour", "gigawatt-hour"), _defineProperty(_EnergyUnit$aliases, "GW-hours", "gigawatt-hour"), _defineProperty(_EnergyUnit$aliases, "gigaWh", "gigawatt-hour"), _defineProperty(_EnergyUnit$aliases, "GWh", "gigawatt-hour"), _EnergyUnit$aliases);
...
EnergyUnit.systems = {
  "metric": ["millijoule", "joule", "kilojoule", "watt-hour", "megajoule", "kilowatt-hour", "gigajoule", "megawatt-hour", "gigawatt-hour"],
  "imperial": ["BTU", "foodcalorie"],
  "uscustomary": ["BTU", "foodcalorie"],
  "conversions": {
    "metric": {
      "uscustomary": {
        "millijoule": "BTU",
