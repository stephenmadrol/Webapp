...
var scenarios = {
  ...
  disabledContainers: (0, _utils.join)((0, _utils.someSpottables)(5), (0, _utils.someContainers)(5), (0, _utils.node)((_node = {}, _defineProperty(_node, _container16.containerAttribute, 'disabled-container'), _defineProperty(_node, 'data-spotlight-container-disabled', true), _node))),
  ...
  mixedOrder: (0, _utils.join)((0, _utils.container)((_container3 = {}, _defineProperty(_container3, _container16.containerAttribute, 'first'), _defineProperty(_container3, "name", 'c1'), _container3)), (0, _utils.spottable)({
    name: 's1'
  }), (0, _utils.container)((_container4 = {}, _defineProperty(_container4, _container16.containerAttribute, 'second'), _defineProperty(_container4, "name", 'c2'), _container4)), (0, _utils.spottable)({
    name: 's2'
  })),
  complexTree: (0, _utils.join)((0, _utils.spottable)(nonSpottable()), (0, _utils.container)((_container7 = {}, _defineProperty(_container7, _container16.containerAttribute, 'first-container'), _defineProperty(_container7, "children", (0, _utils.join)((0, _utils.someSpottables)(2), (0, _utils.container)((_container6 = {}, _defineProperty(_container6, _container16.containerAttribute, 'second-container'), _defineProperty(_container6, "children", (0, _utils.join)((0, _utils.spottable)({
    id: 'secondContainerFirstSpottable'
  }), (0, _utils.someSpottables)(2), (0, _utils.container)((_container5 = {}, _defineProperty(_container5, _container16.containerAttribute, 'third-container'), _defineProperty(_container5, 'data-spotlight-container-disabled', true), _defineProperty(_container5, "children", (0, _utils.join)((0, _utils.someSpottables)(4), (0, _utils.node)({
    id: 'child-of-third'
  }))), _container5)))), _container6)))), _container7))),
  spottablesInDisabledContainer: (0, _utils.container)((_container8 = {}, _defineProperty(_container8, _container16.containerAttribute, 'container'), _defineProperty(_container8, 'data-spotlight-container-disabled', true), _defineProperty(_container8, "children", (0, _utils.someSpottables)(5)), _container8)),
  spottablesInNestedDisabledContainer: (0, _utils.container)((_container10 = {}, _defineProperty(_container10, _container16.containerAttribute, 'container'), _defineProperty(_container10, 'data-spotlight-container-disabled', true), _defineProperty(_container10, "children", (0, _utils.container)((_container9 = {}, _defineProperty(_container9, _container16.containerAttribute, 'child'), _defineProperty(_container9, "children", (0, _utils.someSpottables)(5)), _container9))), _container10)),
  containerWithDefaultAndLastFocused: (0, _utils.container)((_container11 = {}, _defineProperty(_container11, _container16.containerAttribute, 'container'), _defineProperty(_container11, "children", (0, _utils.join)((0, _utils.spottable)({
    id: 'firstSpottable'
  ...
  nestedContainersWithDefaultAndLastFocused: (0, _utils.container)((_container13 = {}, _defineProperty(_container13, _container16.containerAttribute, 'container'), _defineProperty(_container13, "children", (0, _utils.join)((0, _utils.spottable)({
    id: 'firstSpottable'
  }), (0, _utils.someSpottables)(5), (0, _utils.container)((_container12 = {}, _defineProperty(_container12, _container16.containerAttribute, 'child'), _defineProperty(_container12, "id", 'spottableDefault'), _defineProperty(_container12, "className", 'spottable-default'), _defineProperty(_container12, "children", (0, _utils.join)((0, _utils.spottable)({
  ...
  emptySubcontainer: (0, _utils.container)((_container15 = {}, _defineProperty(_container15, _container16.containerAttribute, 'container'), _defineProperty(_container15, "children", (0, _utils.join)((0, _utils.container)(_defineProperty({}, _container16.containerAttribute, 'subcontainer')), (0, _utils.spottable)({
...
describe('container', function () {
  ...
  describe('#getContainerFocusTarget', function () {
    ...
    test('should return the default element when enterTo is "default-element" and defaultElement is within a subcontainer', (0, _utils.testScenario)(scenarios.complexTree, function () {
      (0, _container16.configureContainer)('first-container', {
        enterTo: 'default-element',
        defaultElement: "[".concat(_container16.containerAttribute, "='second-container'] > .spottable")
      });
      (0, _container16.configureContainer)('second-container');
      var expected = 'second-container';
      var actual = (0, _container16.getContainerFocusTarget)('first-container').parentNode.dataset.spotlightId;
      expect(actual).toBe(expected);
    }));
    test('should return the first spottable element when enterTo is "default-element" and defaultElement is within a disabled subcontainer', (0, _utils.testScenario)(scenarios.complexTree, function () {
      (0, _container16.configureContainer)('second-container', {
        enterTo: 'default-element',
        defaultElement: "[".concat(_container16.containerAttribute, "='third-container'] > .spottable")
      });
    ...
    test('should return null for an unconfigured container', (0, _utils.testScenario)(scenarios.complexTree, function () {
      var expected = null;
      var actual = (0, _container16.getContainerFocusTarget)('first-container');
      expect(actual).toBe(expected);
    }));
  });
  describe('#isNavigable', function () {
    ...
    test('should return true for containers', (0, _utils.testScenario)(scenarios.onlyContainers, function (root) {
      var expected = true;
      var actual = (0, _container16.isNavigable)(root.querySelector("[".concat(_container16.containerAttribute, "]")), _container16.rootContainerId, true);
      expect(actual).toBe(expected);
    }));
  ...
  describe('#setContainerLastFocusedElement', function () {
    ...
    test('should update lastFocusedElement to the node\'s container id when element is within a container with enterTo configured', (0, _utils.testScenario)(scenarios.complexTree, function (root) {
      var item = root.querySelectorAll("[".concat(_container16.containerAttribute, "='first-container'] .spottable")).item(0);
      (0, _container16.configureContainer)('first-container', {
        enterTo: 'last-focused'
      });
      (0, _container16.setContainerLastFocusedElement)(item, (0, _container16.getContainersForNode)(item));
    ...
    test('should ignore sub-containers that does not have enterTo configured', (0, _utils.testScenario)(scenarios.complexTree, function (root) {
      var item = root.querySelectorAll("[".concat(_container16.containerAttribute, "='second-container'] .spottable")).item(0);
      (0, _container16.setContainerLastFocusedElement)(item, (0, _container16.getContainersForNode)(item));
      var expected = item;
      var actual = (0, _container16.getContainerConfig)(_container16.rootContainerId).lastFocusedElement;
      expect(actual).toBe(expected);
  ...
  describe('#unmountContainer', function () {
    ...
    test('should return container when last focused is within a subcontainer with enterTo', (0, _utils.testScenario)(scenarios.complexTree, function (root) {
      var item = root.querySelectorAll("[".concat(_container16.containerAttribute, "=\"first-container\"] .spottable")).item(1);
      (0, _container16.configureContainer)('first-container', {
        enterTo: 'last-focused'
      });
      (0, _container16.setContainerLastFocusedElement)(item, (0, _container16.getContainersForNode)(item));
    ...
    test('should save the index as the key when last focused item is only within containers without enterTo configured', (0, _utils.testScenario)(scenarios.complexTree, function (root) {
      var item = root.querySelectorAll("[".concat(_container16.containerAttribute, "=\"second-container\"] .spottable")).item(1);
      (0, _container16.setContainerLastFocusedElement)(item, (0, _container16.getContainersForNode)(item));
      (0, _container16.unmountContainer)(_container16.rootContainerId);
      var expected = 4;
      var actual = (0, _container16.getContainerConfig)(_container16.rootContainerId).lastFocusedKey.key;
  ...
  describe('#getNavigableContainersForNode', function () {
    ...
    test('should include all containers when none are restrict="self-only"', (0, _utils.testScenario)(scenarios.complexTree, function (root) {
      var expected = [_container16.rootContainerId, 'first-container', 'second-container'];
      var actual = (0, _container16.getNavigableContainersForNode)(root.querySelector('#secondContainerFirstSpottable'));
      expect(actual).toEqual(expected);
    }));
  ...
  describe('#getContainerNavigableElements', function () {
    ...
    test('should return an empty array for an unconfigured container', (0, _utils.testScenario)(scenarios.complexTree, function () {
      var expected = [];
      var actual = (0, _container16.getContainerNavigableElements)('first-container');
      expect(actual).toEqual(expected);
    }));
