...
var LabeledIconBase = (0, _kind["default"])({
  name: 'ui:LabeledIcon',
  propTypes:
  /** @lends ui/LabeledIcon.LabeledIconBase.prototype */
  {
    /**
     * The label.
     *
  ...
  render: function render(_ref3) {
    var css = _ref3.css,
        ...
        small = _ref3.small,
        rest = _objectWithoutProperties(_ref3, ["css", "children", "disabled", "icon", "iconComponent", "orientation", "small"]);

    var iconClassName = css.icon; // Rearrange the props to support custom JSX components
    ...
    return _Layout.LayoutBase.inline(_objectSpread({}, rest, {
      align: 'center center',
      disabled: disabled,
...
var LabeledIconDecorator = (0, _compose["default"])((0, _Slottable["default"])({
  slots: ['icon']
}));
/**
