...
describe('VirtualList', function () {
  var clientSize, dataSize, getScrollTo, handlerOnScroll, handlerOnScrollStart, handlerOnScrollStop, items, myScrollTo, onScrollCount, onScrollStartCount, onScrollStopCount, renderItem, resultScrollTop;
  beforeEach(function () {
    clientSize = {
      clientWidth: 1280,
      clientHeight: 720
  ...
  test('should render a list of \'items\'', function () {
    ...
    var actual = subject.find('#item0').text();
  ...
  test('should render (clientHeight / itemHeight + overhang) items', function () {
    ...
    var actual = subject.childAt(0).text().split('Account').length - 1;
    expect(actual).toBe(expected);
  });
  ...
  describe('Voice Control', function () {
    test('should render "data-webos-voice-focused" to outermost node of VirtualList', function () {
      var subject = (0, _enzyme.mount)(_react["default"].createElement(_VirtualList["default"], {
        cbScrollTo: getScrollTo,
        clientSize: clientSize,
        dataSize: dataSize,
      ...
      var expected = true;
      var actual = subject.find(".".concat(_VirtualListModule["default"].virtualList)).prop('data-webos-voice-focused');
      expect(actual).toBe(expected);
    });
    test('should render "data-webos-voice-group-label" to outermost node of VirtualList', function () {
      ...
      var expected = label;
      var actual = subject.find(".".concat(_VirtualListModule["default"].virtualList)).prop('data-webos-voice-group-label');
      expect(actual).toBe(expected);
    });
  });
});