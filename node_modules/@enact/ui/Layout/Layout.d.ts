...
beyond its boundaries (overflowing). See the  size   property
for more details.
 */
  shrink?: boolean;
  /**
 ...
 * 
 * When used in conjunction with  shrink  , the size will be
...
be treated as a pixel value and converted to a
 relative unit   based on the rules of
 ...
 * A stateless component that provides a space for your content in a
 Layout  , without    applied.
 */

export class CellBase extends React.Component<
  CellBaseProps & React.HTMLProps<HTMLElement>
> {}
 ...
 */
  inline?: boolean;
  /**
 * The orientation of the  `Layout` , i.e. how the children  Cells   are
...
export class LayoutBase extends React.Component<
  LayoutBaseProps & React.HTMLProps<HTMLElement>
> {}
...
export interface CellProps extends Merge<CellBaseProps, CellDecoratorProps> {}
/**
 * A stateless component that provides a space for your content in a
 Layout  .
 */
...
export class Cell extends React.Component<
  CellProps & React.HTMLProps<HTMLElement>
> {}
...
export interface LayoutProps
  extends Merge<LayoutBaseProps, ui_ForwardRef_ForwardRefProps> {}
/**
 * A container for  `Cell` s.
 * 
 * A stateless component that acts as a containing area for  Cells   to be
...
export class Layout extends React.Component<
  LayoutProps & React.HTMLProps<HTMLElement>
> {}

export interface ColumnProps
  extends Merge<LayoutProps, ui_ForwardRef_ForwardRefProps> {}
/**
 * A    that positions its  Cells   vertically.
 */
...
export interface RowProps
  extends Merge<LayoutProps, ui_ForwardRef_ForwardRefProps> {}
/**
 * A    that positions its  Cells   horizontally.
 */
