...
describe('Button', function () {
  test('should render with button text upper-cased', function () {
    var msg = 'Hello Button!';
    var button = (0, _enzyme.mount)(_react["default"].createElement(_Button["default"], null, msg));
    var expected = msg.toUpperCase();
