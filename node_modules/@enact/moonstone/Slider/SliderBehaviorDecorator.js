  ...
  function (_React$Component) {
    ...
    _createClass(_class, [{
      ...
      value: function componentDidUpdate(prevProps, prevState) {
        ...
        if (_platform["default"].touch && this.state.dragging && !prevState.dragging) {
          var thisNode = (0, _reactDom.findDOMNode)(this); // eslint-disable-line react/no-find-dom-node

          var sliderNode = thisNode.getAttribute('role') === 'slider' ? thisNode : thisNode.querySelector('[role="slider"]');
          sliderNode.focus();
        }
      }
    }, {
