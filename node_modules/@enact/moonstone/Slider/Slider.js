...
var SliderBase = (0, _kind["default"])({
  ...
  handlers: {
    ...
    onKeyDown: (0, _handle.handle)((0, _handle.forwardWithPrevent)('onKeyDown'), (0, _anyPass["default"])([_utils.handleIncrement, _utils.handleDecrement])),
    onKeyUp: (0, _handle.handle)((0, _handle.forwardWithPrevent)('onKeyUp'), (0, _handle.forProp)('activateOnFocus', false), (0, _handle.forKey)('enter'), (0, _handle.forward)('onActivate'))
  },
  computed: {
  ...
  render: function render(_ref3) {
    ...
    if (process.env.NODE_ENV !== "production") {
      (0, _validators.validateStepped)(rest.max, rest.min, rest.knobStep, 'Slider', '"max"', '"knobStep"');
    }
