...
describe('IncrementSlider Specs', function () {
  ...
  test('should not set decrementButton "aria-label" when decrementButton is disabled', function () {
    var incrementSlider = (0, _enzyme.mount)(_react["default"].createElement(_IncrementSlider["default"], {
      disabled: true,
      value: 10
    }));
  ...
  test('should not set incrementButton "aria-label" when incrementButton is disabled', function () {
    var incrementSlider = (0, _enzyme.mount)(_react["default"].createElement(_IncrementSlider["default"], {
      disabled: true,
      value: 10
    }));
