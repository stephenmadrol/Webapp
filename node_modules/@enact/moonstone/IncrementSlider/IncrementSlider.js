...
var IncrementSliderBase = (0, _kind["default"])({
  ...
  computed: {
    ...
    decrementAriaLabel: function decrementAriaLabel(_ref6) {
      ...
      return !(disabled || value <= min) ? "".concat(valueText != null ? valueText : value, " ").concat(_decrementAriaLabel) : null;
    },
    incrementAriaLabel: function incrementAriaLabel(_ref7) {
      ...
      return !(disabled || value >= max) ? "".concat(valueText != null ? valueText : value, " ").concat(_incrementAriaLabel) : null;
    }
  },
