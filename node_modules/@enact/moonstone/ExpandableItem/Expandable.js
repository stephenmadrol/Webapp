...
var _RadioDecorator = _interopRequireDefault(require("@enact/ui/RadioDecorator"));
...
var Expandable = (0, _hoc["default"])(defaultConfig, function (config, Wrapped) {
  return (0, _Toggleable["default"])({
    toggle: null,
    activate: 'onOpen',
    deactivate: 'onClose',
    prop: 'open'
  }, (0, _RadioDecorator["default"])({
    activate: 'onOpen',
    deactivate: 'onClose',
    prop: 'open'
