...
.picker.joined:global(.spottable):focus .incrementer,
.picker.joined:global(.spottable):focus .decrementer {
  transform: scale(0.95);
}
.picker.joined:global(.spottable):focus.incrementing .incrementer,
.picker.joined:global(.spottable):focus.decrementing .decrementer {
  transform: scale(0.7);
}
...
.picker.small .valueWrapper .item,
.picker.medium .valueWrapper .item,
.picker.large .valueWrapper .item {
  position: absolute;
  top: 0;
  right: 0;
  bottom: 0;
...
.picker:global(.moonstone).joined:global(.spottable):focus {
...
:global(.enact-a11y-high-contrast) .picker:global(.moonstone.highContrast).joined:global(.spottable):focus {
...
.picker:global(.moonstone-light).joined:global(.spottable):focus {
  background-color: #cf0652;
  color: #fff;
}
...
:global(.enact-a11y-high-contrast) .picker:global(.moonstone-light.highContrast).joined:global(.spottable):focus {
...
[data-spotlight-container-muted="true"] .picker:global(.moonstone).joined:global(.spottable):focus {
  background-color: transparent;
  color: #a6a6a6;
}
[data-spotlight-container-muted="true"] .picker:global(.moonstone).joined:global(.spottable):focus .incrementer,
[data-spotlight-container-muted="true"] .picker:global(.moonstone).joined:global(.spottable):focus .decrementer {
  transform: scale(0.7);
}
:global(.enact-a11y-high-contrast) [data-spotlight-container-muted="true"] .picker:global(.moonstone.highContrast).joined:global(.spottable):focus {
  background-color: transparent;
  color: #a6a6a6;
}
:global(.enact-a11y-high-contrast) [data-spotlight-container-muted="true"] .picker:global(.moonstone.highContrast).joined:global(.spottable):focus .incrementer,
:global(.enact-a11y-high-contrast) [data-spotlight-container-muted="true"] .picker:global(.moonstone.highContrast).joined:global(.spottable):focus .decrementer {
  transform: scale(0.7);
}
[data-spotlight-container-muted="true"] .picker:global(.moonstone-light).joined:global(.spottable):focus {
  background-color: transparent;
  color: #4d4d4d;
}
[data-spotlight-container-muted="true"] .picker:global(.moonstone-light).joined:global(.spottable):focus .incrementer,
[data-spotlight-container-muted="true"] .picker:global(.moonstone-light).joined:global(.spottable):focus .decrementer {
  transform: scale(0.7);
}
:global(.enact-a11y-high-contrast) [data-spotlight-container-muted="true"] .picker:global(.moonstone-light.highContrast).joined:global(.spottable):focus {
  background-color: transparent;
  color: #4d4d4d;
}
:global(.enact-a11y-high-contrast) [data-spotlight-container-muted="true"] .picker:global(.moonstone-light.highContrast).joined:global(.spottable):focus .incrementer,
:global(.enact-a11y-high-contrast) [data-spotlight-container-muted="true"] .picker:global(.moonstone-light.highContrast).joined:global(.spottable):focus .decrementer {
  transform: scale(0.7);
}
