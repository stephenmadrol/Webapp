...
function (_React$Component) {
  ...
  function PickerBase(props) {
    ...
    _this.computeNextValue = function (delta) {
      ...
      return wrap ? wrapRange(min, max, value + delta) : (0, _clamp["default"])(min, max, value + delta);
    };
  ...
  _createClass(PickerBase, [{
    ...
    value: function render() {
      ...
      var _this$props12 = this.props,
          ...
          noAnimation = _this$props12.noAnimation,
          ...
          rest = _objectWithoutProperties(_this$props12, ["aria-valuetext", "noAnimation", "children", "disabled", "id", "index", "joined", "max", "min", "onSpotlightDisappear", "orientation", "reverse", "spotlightDisabled", "step", "value", "width"]);
      ...
      if (!noAnimation && !disabled) {
        arranger = orientation === 'vertical' ? _ViewManager.SlideTopArranger : _ViewManager.SlideLeftArranger;
      }
