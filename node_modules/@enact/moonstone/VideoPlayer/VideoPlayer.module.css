...
.videoPlayer .fullscreen .bottom .sliderFrame .mediaSlider:global(.spottable):focus .knob::before {
...
.videoPlayer .fullscreen .bottom .controlsFrame .rightComponents {
  flex: 0 1;
  flex-basis: calc(( 4.5rem * var(--moon-video-player-max-side-components)) - 1rem );
  white-space: nowrap;
  padding: 0.125rem 0;
}
.videoPlayer .fullscreen .bottom .controlsFrame .leftComponents {
...
:global(.enact-locale-right-to-left) .videoPlayer .fullscreen .bottom .controlsFrame .moreButton {
  transform: scaleX(-1);
}
...
.videoPlayer:global(.moonstone) .overlay::after {
  background: initial;
}
...
:global(.enact-a11y-high-contrast) .videoPlayer:global(.moonstone.highContrast) .overlay::after {
...
.videoPlayer:global(.moonstone-light) .overlay::after {
  background: initial;
}
...
:global(.enact-a11y-high-contrast) .videoPlayer:global(.moonstone-light.highContrast) .overlay::after {
